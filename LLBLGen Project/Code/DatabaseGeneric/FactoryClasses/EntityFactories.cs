...
namespace YumCity_Migrations.FactoryClasses
{
		...
		where TEntity : EntityBase2, IEntity2
	{
		...
		public EntityFactoryBase2(string entityName, YumCity_Migrations.EntityType typeOfEntity, bool isInHierarchy) : base(entityName, (int)typeOfEntity)
		{
		...
		/// <inheritdoc/>
		public override IEntity2 CreateEntityFromEntityTypeValue(int entityTypeValue) {	return GeneralEntityFactory.Create((YumCity_Migrations.EntityType)entityTypeValue); }
	...
	{
		/// <summary>CTor</summary>
		public CategoryEntityFactory() : base("CategoryEntity", YumCity_Migrations.EntityType.CategoryEntity, false) { }
		/// <inheritdoc/>
	...
	{
		/// <summary>CTor</summary>
		public IngredientEntityFactory() : base("IngredientEntity", YumCity_Migrations.EntityType.IngredientEntity, false) { }
		/// <inheritdoc/>
	...
	{
		/// <summary>CTor</summary>
		public InstructionEntityFactory() : base("InstructionEntity", YumCity_Migrations.EntityType.InstructionEntity, false) { }
		/// <inheritdoc/>
	...
	{
		/// <summary>CTor</summary>
		public RecipeEntityFactory() : base("RecipeEntity", YumCity_Migrations.EntityType.RecipeEntity, false) { }
		/// <inheritdoc/>
	...
	{
		/// <summary>CTor</summary>
		public RecipeCategoryEntityFactory() : base("RecipeCategoryEntity", YumCity_Migrations.EntityType.RecipeCategoryEntity, false) { }
		/// <inheritdoc/>
	...
	{
		/// <summary>CTor</summary>
		public RefreshTokenEntityFactory() : base("RefreshTokenEntity", YumCity_Migrations.EntityType.RefreshTokenEntity, false) { }
		/// <inheritdoc/>
	...
	{
		/// <summary>CTor</summary>
		public UserEntityFactory() : base("UserEntity", YumCity_Migrations.EntityType.UserEntity, false) { }
		/// <inheritdoc/>
	...
	public partial class GeneralEntityFactory
	{
		...
		public static IEntity2 Create(YumCity_Migrations.EntityType entityTypeToCreate)
		{
	...
	public static class EntityFactoryFactory
	{
		...
		{
			foreach(int entityTypeValue in Enum.GetValues(typeof(YumCity_Migrations.EntityType)))
			{
				var factory = GetFactory((YumCity_Migrations.EntityType)entityTypeValue);
		...
		/// <summary>Gets the factory of the entity with the YumCity_Migrations.EntityType specified</summary>
		/// <param name="typeOfEntity">The type of entity.</param>
		/// <returns>factory to use or null if not found</returns>
		public static IEntityFactory2 GetFactory(YumCity_Migrations.EntityType typeOfEntity)
		{
			switch(typeOfEntity)
			{
				case YumCity_Migrations.EntityType.CategoryEntity:
					return new CategoryEntityFactory();
				case YumCity_Migrations.EntityType.IngredientEntity:
					return new IngredientEntityFactory();
				case YumCity_Migrations.EntityType.InstructionEntity:
					return new InstructionEntityFactory();
				case YumCity_Migrations.EntityType.RecipeEntity:
					return new RecipeEntityFactory();
				case YumCity_Migrations.EntityType.RecipeCategoryEntity:
					return new RecipeCategoryEntityFactory();
				case YumCity_Migrations.EntityType.RefreshTokenEntity:
					return new RefreshTokenEntityFactory();
				case YumCity_Migrations.EntityType.UserEntity:
	...
	{
		/// <summary>Gets the factory of the Entity type with the YumCity_Migrations.EntityType value passed in</summary>
		...
		{
			return new DynamicRelation(leftOperand, joinType, (YumCity_Migrations.EntityType)Enum.Parse(typeof(YumCity_Migrations.EntityType), rightOperandEntityName, false), aliasRightOperand, onClause);
		}

		/// <inheritdoc/>
		public override IDynamicRelation CreateDynamicRelation(string leftOperandEntityName, JoinHint joinType, string rightOperandEntityName, string aliasLeftOperand, string aliasRightOperand, IPredicate onClause)
		{
			return new DynamicRelation((YumCity_Migrations.EntityType)Enum.Parse(typeof(YumCity_Migrations.EntityType), leftOperandEntityName, false), joinType, (YumCity_Migrations.EntityType)Enum.Parse(typeof(YumCity_Migrations.EntityType), rightOperandEntityName, false), aliasLeftOperand, aliasRightOperand, onClause);
		}
		
		/// <inheritdoc/>
		public override IDynamicRelation CreateDynamicRelation(IEntityFieldCore leftOperand, JoinHint joinType, string rightOperandEntityName, string aliasLeftOperand, string aliasRightOperand, IPredicate onClause)
		{
			return new DynamicRelation(leftOperand, joinType, (YumCity_Migrations.EntityType)Enum.Parse(typeof(YumCity_Migrations.EntityType), rightOperandEntityName, false), aliasLeftOperand, aliasRightOperand, onClause);
		}
		
		/// <inheritdoc/>
		protected override IEntityFactoryCore GetFactoryImpl(int entityTypeValue) { return EntityFactoryFactory.GetFactory((YumCity_Migrations.EntityType)entityTypeValue); }
